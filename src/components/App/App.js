        ...
        return (
            ...
            <div className="App">
              ...
              <div className="App-playlist">
                ...
                <Playlist updatePlaylistName={this.updatePlaylistName} onRemove={this.removeTrack} playlistName={this.state.playlistName} playlistTracks={this.state.playlistTracks}/>
              </div>
            </div>
          </div>
            )
